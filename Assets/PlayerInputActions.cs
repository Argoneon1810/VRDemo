...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_XRIUI.enabled, "This will cause a leak and performance issues, PlayerInputActions.XRIUI.Disable() has not been called.");
    ...
    {
        private @PlayerInputActions m_Wrapper;
        public XRIUIActions(@PlayerInputActions wrapper) { m_Wrapper = wrapper; }
